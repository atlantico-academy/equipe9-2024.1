...
Este conjunto de dados contém a contagem diária de bicicletas alugadas entre os anos de 2011 e 2012 no sistema de compartilhamento de bicicletas da Capital com as correspondentes informações meteorológicas e sazonais. [graphical abstract](https://www.elsevier.com/authors/tools-and-resources/visual-abstract).

## Desenvolvedores
 - [Michel da Silva #1](https://github.com/Michelitossilva)
 - [João Vitor Lucena de Souza Pinheiro #2](https://github.com/J-V-Lucena)
